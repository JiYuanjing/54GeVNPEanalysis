...
void compare2PE_my()
{
  ...
  drawPartPtPlot("Partner e",pdf ,c ,realdata,"rescale_combine_0.7.root","0.7"); 
  drawPartPtPlot("Partner e",pdf ,c ,realdata,"rescale_combine_0.8.root","0.8"); 
  drawPartPtPlot("Partner e",pdf ,c ,realdata,"rescale_combine.root","1"); 
  drawPartPtPlot("Partner e",pdf ,c ,realdata,"rescale_combine_1.2.root","1.2"); 
  drawPartPtPlot("Partner e",pdf ,c ,realdata,"rescale_combine_1.3.root","1.3"); 
