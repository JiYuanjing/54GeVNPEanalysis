...
void calgamma()
{
  ...
  /* TString filenameEta="D2ev2.root"; */
  TString filenameEta="noresDecay25_fonll62.root";
  /* TFile* fout = new TFile("fread_pi0_eta_2gamma.root","recreate"); */
  TFile* fout = new TFile("fread_fonll62.root","recreate");
  ...
  drawAndWriteGamma(filenameEta,fout,pdf,c,"eta",1);
