...
run_calPhoeff("rescaleFile\/rescale_pi0.root","pdf\/PhoEff_"+name[1]+".pdf","output\/PhoEff_"+name[1]+".root")
run_calPhoeff("rescaleFile\/rescale_eta.root","pdf\/PhoEff_"+name[2]+".pdf","output\/PhoEff_"+name[2]+".root")
# run_calPhoeff("data\/embeddQa_gamma_pi0_Apr12.root","pdf\/PhoEff_"+name[3]+".pdf","output\/PhoEff_"+name[3]+".root")
# run_calPhoeff("data\/embeddQa_gamma_eta_Apr12.root","pdf\/PhoEff_"+name[4]+".pdf","output\/PhoEff_"+name[4]+".root")
# run_calPhoeff("data\/embeddQa_gamma_dirpho_Apr12.root","pdf\/PhoEff_"+name[5]+".pdf","output\/PhoEff_"+name[5]+".root")
run_calPhoeff("rescaleFile\/rescale_gamma.root","pdf\/PhoEff_"+"gamma"+".pdf","output\/PhoEff_"+"gamma"+".root")
# run_calPhoeff("data\/embeddQa_gamma_Apr20.root","pdf\/PhoEff_"+"gamma"+".pdf","output\/PhoEff_"+"gamma"+".root")

command="root -b -q plotComponent.C\(\\\"output\/PhoEff_\\\",\\\"%s\\\",\\\"%s\\\",\\\"%s\\\",\\\"%s\\\",\\\"%s\\\",\\\"%s\\\",0\)"%("gamma",name[1],name[2],name[3],name[4],name[5])
subprocess.call(command,shell=True)
